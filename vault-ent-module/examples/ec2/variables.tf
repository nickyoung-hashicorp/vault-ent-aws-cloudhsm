...
variable "cloudhsm_security_group" {
  type = string
  description = "Security Group ID generated by provisioning the CloudHSM that will need to be attached to the EC2 (Vault) instance."
}