resource "aws_iam_instance_profile" "vault" {
  name_prefix = "${var.friendly_name_prefix}-vault"
...
resource "aws_iam_role_policy" "cloud_auto_join" {
  count  = var.user_supplied_iam_role_name != null ? 0 : 1
  name   = "${var.friendly_name_prefix}-vault-auto-join"
...
resource "aws_iam_role_policy" "auto_unseal" {
  count  = var.user_supplied_iam_role_name != null ? 0 : 1
  name   = "${var.friendly_name_prefix}-vault-auto-unseal"
  role   = aws_iam_role.instance_role[0].id
...
resource "aws_iam_role_policy" "session_manager" {
  count  = var.user_supplied_iam_role_name != null ? 0 : 1
  name   = "${var.friendly_name_prefix}-vault-ssm"
  role   = aws_iam_role.instance_role[0].id
...
resource "aws_iam_role_policy" "secrets_manager" {
  count  = var.user_supplied_iam_role_name != null ? 0 : 1
  name   = "${var.friendly_name_prefix}-vault-secrets-manager"
  role   = aws_iam_role.instance_role[0].id
